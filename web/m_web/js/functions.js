...
function clearImgMenu(id){
	...
	$("#menu_li_"+id).css("background-color", "#19DDBC");
...
function clearTxt(opc, obj, texto){
	if(opc == 1){
		$("#"+obj).attr("value", "");
	}else{
		$("#"+obj).attr("value", texto);
	}
}
...
function styleUL(opc){
	if(opc){
		$('#menu_li_1').css("background-color","#AE2320");
		$('#menu_a_1').css("color","#FFF");
	}else{
		$('#menu_li_1').css("background-color","#FFF");
		$('#menu_a_1').css("color","#000");
	}	
}