...
*
*/
(function(i){var l,t,r,q,a,p,h,o,j,w,b={boxId:"superbox",boxClasses:"",overlayOpacity:0.8,boxWidth:"722",boxHeight:"518",loadTxt:"Loading...",closeTxt:"Close",beforeShow:function(){}},x={},m=false,s=i([]);
...
h=i('').appendTo(q).hide();j=i("").appendTo(h);
o=i("").appendTo(h);
a=i('<div align="right" style="height:10px;"><a class="close">'+w.closeTxt+"</a></div>").prependTo(q).find("a");
